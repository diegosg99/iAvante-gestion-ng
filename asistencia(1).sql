...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-03-2023 a las 12:34:49
...
('03096815A', 'Marta', 'Albalate Ramón', 'mariaalbalate@gmail.com', 638269023, 'Frutas del bosque', '3GI02511823004', 1, '2023-03-14 09:21:35', NULL),
('05324456W', 'Nerissa', 'Alvarez Alvarez', 'nerissa@gmail.com', 667334229, 'Muy buen curso', '3GI02511823004', 1, '2023-03-14 09:29:43', NULL),
('12344321P', 'María Teresa', 'Casal García De Lomas', 'casalas@gmail.com', 600983562, 'Muy buen curso de noche y de día', '3SD09011823008', 1, '2023-03-28 10:01:32', 'null'),
('17893452L', 'Juanito', 'Morales de la Sierra', 'juanitomorales@gmail.com', 663878220, 'Con un poco de pan y acceitunas', '3SD09011823008', 1, '2023-03-24 10:40:47', NULL),
('34567712K', 'Pedro', 'Heredia Castillo', 'pedroheredia@gmail.com', 666983764, 'El hijo perdido del churumbe gitano', '3GI02511823004', 1, 'Tue Mar 14 2023 10:21:35 GMT+0100 (hora estándar de Europa central)', 'null'),
('37881294L', 'Fredy Alberto', 'Arevalo Henriquez', 'thanatos@gmail.com', 676767584, 'Me gustaría un curso de tanatopraxia jaja saludos', '3TC07910023056', 1, '2023-03-23 09:55:34', NULL),
('48781234H', 'Paula', 'Cortisol Perez', 'paulitacorticoide@gmail.com', 654667220, 'null', '3SD09011823008', 1, 'Wed Mar 22 2023 15:53:33 GMT+0100 (hora estándar de Europa central)', 'null'),
('50625993A', 'Consuelo', 'Aranda Martínez', '', 657453426, '', '3SD09011823008', 1, '2023-03-21 14:40:39', NULL),
('77585672W', 'Alejandro', 'Alvarez Maxiásia', 'diegosilva@gmail.com', 695918615, 'El material es muy bueno y los docentes saben de lo que hablan.', '3TC07910023056', 1, '2023-03-24 11:21:46', NULL);
...
INSERT INTO `valoracion` (`id`, `course`, `student`, `question1`, `question2`, `question3`, `observations`, `global`) VALUES
('47c46eaa-1884-40ee-bd65-9c6daae4b943', '3SD09011823008', '12344321P', 100, 90, 80, 'Me encantó', '93'),
('b2f81c08-4235-44a8-aa57-5dd4482f71a1', '3SD09011823008', '17893452L', 100, 26, 50, 'lokurion', '58.67');
...
--
ALTER TABLE `valoracion`
  ADD CONSTRAINT `valoracion_ibfk_1` FOREIGN KEY (`student`) REFERENCES `alumnos` (`dni`),
  ADD CONSTRAINT `valoracion_ibfk_2` FOREIGN KEY (`course`) REFERENCES `cursos` (`code`);
COMMIT;
